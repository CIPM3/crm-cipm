...
export default function AgendadorPage() {
    ...
    useEffect(() => {
        ...
        if (User.role === "agendador") {
            router.push('/admin/clases/prueba/agendador/' + User.id)
        } else {
        ...
        return (
            <div className="space-y-6 h-[86dvh] flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-4">Cargando agendadores...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="space-y-6 h-[86dvh]">
            ...
            {InstructoresRoles.length === 0 && !loading && (
                <div className="text-center py-12">
                    <p className="text-muted-foreground">No hay agendadores disponibles</p>
                </div>
            )}
        </div>
    )
